		...
		<div class="col-12">
			<div class="card mb-4">
				<div class="card-header pb-0">
					...
					<a href="<?= base_url('Gudang/cProduk/create') ?>" class="btn btn-primary">Tambah Data Produk</a>
					<?php
								...
								?>
									<tr>
										...
										<td class="align-middle text-center text-sm">
											<a href="<?= base_url('Gudang/cProduk/edit/' . $value->id_produk) ?>" class="btn btn-warning btn-sm">Edit</a>
											<a href="<?= base_url('Gudang/cProduk/delete/' . $value->id_produk) ?>" class="btn btn-danger btn-sm">Hapus</a>
										</td>
